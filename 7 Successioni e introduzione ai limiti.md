...
>**Una funzione $f: \mathbb{N} \to \mathbb{R}$ si chiama successione di numeri reali.**

Più in generale si parla di successioni anche quando $f: A\subseteq \mathbb{N} \to \mathbb{R}$, con $A = \{n\in \mathbb{N}: n\ge n_0 \}$ per qualche $n_o \in \mathbb{N}$.

Spesso è usata la notazione $a_n, \{a_{n}\}, \{a_{n}\}_{n \ge n_0}$ invece di $f(n)$.

Il grafico di una successione è dato da una sequenza di **punti** in $\mathbb{R}^2$.
...
- Se $\exists M \in \mathbb{R}: a_n\le M , \forall n\in \mathbb{N}$ allora la successione è detta **limitata dall’alto**;
- Se $\exists m \in \mathbb{R}: a_n\ge m , \forall n\in \mathbb{N}$ allora la successione è detta **limitata dal basso**;
- Se $\exists m,M \in \mathbb{R}: m\le a_n\le M , \forall n\in \mathbb{N}$ allora la successione è detta **limitata**;
...
>**Diremo che una successione converge ad un numero reale $\ell\in\mathbb{R}$ e scriveremo $\lim_{n\to\infty}a_n = \ell$ se 
...
> **Data una successione $a_n$, se $\exists \lim_{n\to\infty}a_n=\ell\in \mathbb{R}$, allora tale limite è unico.**
> 
...
## 2.5 Estensione di $\mathbb{R}$ e successioni regolari e irregolari

> Definizione: $\mathbb{R}$ esteso
> **$\overline \mathbb{R} = \mathbb{R}^* = \mathbb{R} \cup \{\pm\infty\}$.**
> 

Data una successione $a_n$, se essa **converge oppure diverge**, allora diremo che $a_n$ è **regolare** e che $\exists \lim_{n\to\infty}a_n=\ell\in \overline\mathbb{R}$. Se invece la successione **non converge né diverge**, diremo che essa è **irregolare** (oppure **oscillante** oppure **indeterminata**) e che $\mathbb{N}exists \lim_{n\to\infty}a_n$.

## 2.6 Estensione del teorema dell’unicità del limite

Il teorema dell’unicità del limite visto al punto 2.3 di questo capitolo può essere esteso a tutto $\overline\mathbb{R}$.

>Teorema: unicità del limite in $\mathbb{R}$ esteso
> **Data una successione $a_n$, se $\exists \lim_{n\to\infty}a_n=\ell\in \overline\mathbb{R}$, allora tale limite è unico.**
> 
...
**Diremo che $a_n$ converge per eccesso a $\ell\in \mathbb{R}$ se $\lim_{n\to\infty}a_n = \ell$ e $a_n \ge \ell$ definitivamente per $n\in \mathbb{N}$ e scriveremo $\lim_{n\to\infty}a_n = \ell^+$ se**
**$$\forall \epsilon >0\exists N\in \mathbb{N}: \forall n > N ,\ell<a_n<\ell+\epsilon$$** 
>
>**Diremo che $a_n$ converge per difetto a $\ell\in \mathbb{R}$ se $\lim_{n\to\infty}a_n = \ell$ e $a_n \le \ell$ definitivamente per $n\in \mathbb{N}$ e scriveremo $\lim_{n\to\infty}a_n = \ell^-$ se**
...
$\exists \lim_{n\to\infty}a_n=\ell\in \mathbb{R}$.
Inoltre se $a_n$ è crescente $\ell = \sup a_n \in \mathbb{R}$ e $\lim_{n\to\infty}a_n= \ell^-$, mentre se  è decrescente $\ell = \inf a_n \in \mathbb{R}$ e $\lim_{n\to\infty}a_n= \ell^+$.**
> 
...
>Teorema
> **Sia $a_n$ una successione monotona. Allora essa ammette limite $\ell \in \overline \mathbb{R}.$
Inoltre se $a_n$ è crescente $\ell = \sup a_n \in \overline\mathbb{R}$, mentre se  è decrescente $\ell = \inf a_n \in \overline\mathbb{R}$.**
> 
...
<img src="https://www.notion.so/icons/circle-alternate_red.svg" alt="https://www.notion.so/icons/circle-alternate_red.svg" width="15px" /> **Osservazione**
$a_n$ monotona $\mathbb{R}ightarrow$ $a_n$ regolare, ma $a_n$ regolare $\mathbb{N}Rightarrow$$a_n$ monotona

>Teorema
> **Data una successione $a_n$, se $\exists \lim_{n\to\infty}a_n=\ell\in \mathbb{R}$, allora essa è limitata.**
> 
...
> **Data una successione $a_n$, se $\exists \lim_{n\to\infty}a_n=\ell\in \overline\mathbb{R}$ e $\ell>0$
$\mathbb{R}ightarrow$  $a_n > 0$ definitivamente in $n\in \mathbb{N}$. 
Similmente se $\ell<0$
$\mathbb{R}ightarrow$ $a_n < 0$ definitivamente in $n\in \mathbb{N}$.**
> 
...
2. Se $\ell \in \mathbb{R} , \ell > 0$, nella definizione di limite adottiamo $\epsilon = \frac{\ell}{2}$ . Da questo ricaviamo che $a_n >  \ell - \epsilon = \frac{\ell}{2} > 0$ definitivamente in $n\in \mathbb{N}$.
...
> **Data una successione $a_n$, se $\exists \lim_{n\to\infty}a_n=\ell\in \overline\mathbb{R}$ e $a_n \ge 0$ definitivamente in $n\in \mathbb{N}$ $\mathbb{R}ightarrow$  $\ell \ge 0$. 
Similmente se $a_n \le 0$ definitivamente in $n \in \mathbb{N}$ $\mathbb{R}ightarrow$  $\ell \le 0$.**
> 
...
Parimenti se $a_n > 0$ $\forall n\in\mathbb{N}$ ed $\exists\lim_{n\to\infty}a_n$ $\mathbb{R}ightarrow$ $\ell\ge0$ e non $\ell>0$.