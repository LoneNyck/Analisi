...
Data una successione $a_n$, se essa **converge oppure diverge**, allora diremo che $a_n$ è **regolare** e che $\exists \lim_{n\to\infty}a_n=\ell\in \overline\mathbb{R}$. Se invece la successione **non converge né diverge**, diremo che essa è **irregolare** (oppure **oscillante** oppure **indeterminata**) e che $\nexists \lim_{n\to\infty}a_n$.
...
> **Data una successione $a_n$, se $\exists \lim_{n\to\infty}a_n=\ell\in \overline\mathbb{R}$ e $a_n \ge 0$ definitivamente in $n\in \mathbb{N}$ $\Rightarrow$  $\ell \ge 0$. 
