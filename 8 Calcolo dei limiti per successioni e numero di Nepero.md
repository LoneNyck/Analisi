...
>3. **$\lim_{n\to\infty}{a_n \over b_n} = {a \over b}, b\mathbb{N}eq 0$**
...
>**Siano $a_n$  e $b_n$ due successioni ed $\exists\lim_{n\to\infty}a_n=a\in \mathbb{R}$ ed $\exists\lim_{n\to\infty}b_n=b\in \mathbb{R}$.**
>**Allora:**
>1. **$a>b$ $\mathbb{R}ightarrow$ $a_n>b_n$ definitivamente in $n\in\mathbb{N}$**
>2. **$a_n \ge b_n$ definitivamente in $n \in \mathbb{N}$ $\mathbb{R}ightarrow$  $a\ge b$**
...
$\mathbb{R}ightarrow$  $\exists \lim_{n\to\infty}b_n = l \in \mathbb{R}$**
> 
...
> $\mathbb{R}ightarrow$  $\exists \lim_{n\to\infty}b_n = +\infty$**
> - **se $b_n$ diverge ed $\exists\lim_{n\to\infty}b_n=-\infty$ 
> $\mathbb{R}ightarrow$  $\exists \lim_{n\to\infty}a_n = -\infty$**
...
>$\exists\lim_{n\to\infty}b_n=0 \in \mathbb{R}$ $\mathbb{R}ightarrow$ $\exists\lim_{n\to\infty}a_n=0 \in \mathbb{R}$**
>2. **Date due successioni $a_n$ e $b_n$ tali che $a_n$ sia limitata e $\exists\lim_{n\to\infty}b_n=0$ $\mathbb{R}ightarrow$ $\exists\lim_{n\to\infty}a_nb_n=0$**
...
$\mathbb{R}ightarrow$ $\lim_{n\to\infty}a_n+b_n=\pm \infty$
...
$\mathbb{R}ightarrow$ $\lim_{n\to\infty}a_nb_n=\pm \infty$ con le usuali regole del segno.
4. Se $\lim_{n\to\infty}a_n = \ell \in \overline \mathbb{R} \setminus\{0\}$ e $\lim_{n\to\infty}b_n = 0^\pm$
$\mathbb{R}ightarrow$ $\lim_{n\to\infty}{a_n\over b_n}=\pm \infty$ con le usuali regole del segno.
5. Se $\lim_{n\to\infty}a_n = \ell \in \mathbb{R}$ e $\lim_{n\to\infty}b_n = \pm \infty$
$\mathbb{R}ightarrow$ $\lim_{n\to\infty}{a_n\over b_n}=0$
...
>Teorema 
> **Se $a_b$ e $b_n$ sono successioni $\lim_{n\to\infty}a_n = a \in \overline \mathbb{R}, a>0$ e $\lim_{n\to\infty}b_b = b \in \overline \mathbb{R}$ $\mathbb{R}ightarrow$ $\lim_{n\to\infty}{a_n}^{b_n}= a^b$.**
> 
...
- $a_n=1$ e $b_n =n$ $\mathbb{R}ightarrow$ ${a_n}^{b_n} = 1^n = 1 \to 1$, $n \to \infty$
- $a_n=0$ e $b_n =n$ $\mathbb{R}ightarrow$ ${a_n}^{b_n} = 0^n = 0 \to 0$, $n \to \infty$
...
1. Mostrare che una successione è crescente  $a_n \ge a_{n-1}, \forall n\ge2$ $\mathbb{R}ightarrow$ $\frac{a_n}{a_{n-1}}\ge1$, in cui il passaggio fondamentale per la dimostrazione della disuguaglianza è la disuguaglianza di Bernoulli.
2. Per dimostrare che a_n sia limitata introduciamo la successione b_n decrescente : $a_n \le b_n \forall n\in\mathbb{N}, n>1$ $\mathbb{R}ightarrow$ $a_n \le b_n \le b_1 ,\forall n\ge1$. 
...
> 
> - **$\ell > 1 \mathbb{R}ightarrow \lim_{n\to\infty}a_n=+\infty$;**
> - **$0< \ell < 1 \mathbb{R}ightarrow \lim_{n\to\infty}a_n=0$;**
> - **$\ell = 1 \mathbb{R}ightarrow$  non si può dire nulla sul limite di $a_n$**
