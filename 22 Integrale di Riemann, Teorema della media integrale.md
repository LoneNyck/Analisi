...
Essendo $f$ continua, per il teorema dei valori intermedi $\operatorname{Im}f= [m,M]$. Quindi $\frac 1{b-a}\int_a^bf(x)\ dx\in \operatorname{Im}f\mathbb{R}ightarrow \exists x_0\in [a,b]: f(x_0)=\frac 1{b-a}\int_a^bf(x)\ dx$.
