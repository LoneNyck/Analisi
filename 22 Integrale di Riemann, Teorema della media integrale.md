...
Data $f:[a,b]\to\R$ limitata in $[a,b]$, come si può definire e poi calcolare l’area sottesa al suo grafico?
...
>Definizione
>**Sia $f:[a,b]\to\R$ limitata in $[a,b]$. Se detta $S_n$ una qualunque successione di somme di Cauchy - Riemann esiste finita tale che $\lim_{n\to\infty}S_n= L\in \R$ ed inoltre tale limite $L\in \R$ non dipende dalla scelta dei punti $t_k^{(n)}$ operata ad ogni passo della costruzione, chiameremo $L= \lim_{n\to\infty}S_n = \int_a^bf(x) \ dx$ integrale di Riemann di $f$ in $[a,b]$.**

>Definizione
>**Se $f:[a,b]\to\R$ limitata in $[a,b]$ è Riemann integrabile in $[a,b]$ e se $f(x)\ge 0$ in $[a,b]$, posto $D= \{(x,y): a\le x\le b, 0\le y\le f(x)\}$, definiamo l’area sottesa al grafico $\operatorname{Area}(D)= \int_a^bf(x) \ dx$.**


<img src="https://www.notion.so/icons/circle-alternate_red.svg" alt="https://www.notion.so/icons/circle-alternate_red.svg" width="15px" />**Osservazione**
Se $f:[a,b]\to\R$ limitata in $[a,b]$ è Riemann integrabile in $[a,b]$ e può essere negativa in $[a,b]$ l’area $\int_a^bf(x) \ dx$ è un’area con segno. L’area geometrica della regione di piano compresa tra $x= a,x = b, y = 0$ e il grafico di $f$ è invece data da $\int_a^b|f(x)| \ dx$
...
- Se $f:[a,b]\to\R$ non è limitata, essa non è Riemann integrabile

# 2. Classi di funzioni integrabili

>Teorema
> **Se $f:[a,b]\to\R$ è monotona, allora essa è Riemann integrabile in $[a,b]$.**
> 
...
>Teorema
> **Se $f:[a,b]\to\R$ è continua in $[a,b]$, allora essa è Riemann integrabile in $[a,b]$.**
> 
...
>Teorema
> **Se $a<c<b$ e se $f_1:[a,c]\to\R$ e $f_1:[c,b]\to\R$ sono funzioni Riemann integrabili rispettivamente in $[a,c]$ e $[c,b]$, allora $\forall \alpha \in \R$
...
>Teorema
> **Siano $f,g:[a,b]\to\R$ Riemann integrabili, $\alpha,\beta\in \R$. Allora$\alpha f(x) +\beta g(x)$ è Riemann integrabile e vale inoltre che
 $\int_a^b \alpha f(x)+\beta g(x) \ dx = \alpha \int_a^b f(x) \ dx + \beta \int_a^b g(x) \ dx$**
> 

>Teorema
> **Sia $f:[a,b]\to\R$ Riemann integrabile. Sia $\phi :[c,d]\to\R$ è continua e tale che $\operatorname{Im}f\subseteq[c,d]$. Allora $\phi \circ f :[a,b]\to\R$, $\phi\circ f(x) = \phi(f(x))$ è Riemann integrabile.**
> 
...
>Teorema
> **Se $f:[a,b]\to\R$ è Riemann integrabile e $f(x) \ge 0$, allora $\int_a^b f(x) \ dx \ge 0$.**
> 

>Teorema
> **Se $f,g:[a,b]\to\R$ sono Riemann integrabili e $f(x) \ge g(x)$ in $[a,b]$, allora $\int_a^bf(x) \ dx \ge \int_a^bg(x) \ dx$**
> 

>Teorema
> **Se $f:[a,b]\to\R$ è Riemann integrabile, allora 
...
>**Se $f:[a,b]\to\R$ è Riemann integrabile in $[a,b]$, allora $\frac 1{b-a}\int_a^bf(x)\ dx$ si dice valor medio di $f$ in $[a,b]$.**
...
> **Sia $f:[a,b] \to \R$ Riemann integrabile in $[a,b]$. Supponiamo che $f$ ammetta primitiva $F:[a,b]\to \R$ in $[a,b]$, ossia $F'(x) = f(x)$. 
...
>Teorema
> **Siano $f,g:[a,b]\to\R$ funzioni derivabili in $[a,b]$, con $f,g$  Riemann integrabili in $[a,b]$. Allora**
> 
> $$
...
>Teorema
> **Siano $f:[a,b]\to\R$ continua,  e $\psi :[\alpha,\beta]\to[a,b]$ derivabile e suriettiva, con $\psi' :[\alpha,\beta]\to[a,b]$ Riemann integrabile in $[a,b]$. Allora**
> 
> 
> $$
...
Sia $f:[a,b] \to \R, r_1,...,r_n$ punti in $[a,b]$ tali che $r_0= a< r_1<...<r_n<r_{n+1}= b$ e $f(x) = \begin{cases}f_1(x) , & a\le x < r_1 \\f_2(x) , & r_1< x < r_2\\...\\f_n(x) , & r_{n-1}< x < r_n\\f_{n+1}(x) , & r_n< x \le b\end{cases}$Riemann integrabile in ciascuno dei domini $[r_{i-1};r_i]$.
