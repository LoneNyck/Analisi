...
- $\forall a>0\mathbb{R}ightarrow a^0 = 1$ 
$a^m = a\cdot a \cdot a...$ $m$ volte
$a^{1\over n} = \sqrt[n]{a}$
$a^{m\over n} = (a^{m})^{1\over n} = \sqrt[n]{a^m}$, $\forall a\ge0, m, n \in \mathbb{N}, n\mathbb{N}eq 0$
- $\forall a \in \mathbb{R}, a > 0, a^{-1} = \frac{1}{a}$
$a^{-{1\over m}}  =(a^{1\over m})^{-1} = {1 \over a^{1 \over m}}$, $\forall a >0, m \in \mathbb{N}, m\mathbb{N}eq 0$
</aside>
...
> **Dati $y, a \in \mathbb{R}$ con $y > 0, a >0 , a \mathbb{N}eq 1$ $\mathbb{R}ightarrow$ $\exists! x \in \mathbb{R}: a^x = y$.**
...
In una tabella infinita vengono disposte tutte le frazioni ${m \over n}, m, n \in \mathbb{N}, m, n \mathbb{N}eq 0$, dove nella 
...
<img src="https://www.notion.so/icons/circle-alternate_red.svg" alt="https://www.notion.so/icons/circle-alternate_red.svg" width="15px" /> **Osservazione**
$\mathbb{R} = \mathbb{Q} + \mathbb{R}/\mathbb{Q} \mathbb{R}ightarrow \mathbb{R}/\mathbb{Q}$  non è numerabile, ha cardinalità maggiore di $\mathbb{N}$ e si dimostra avere potenza del continuo.
