...
$\mathbb{R}ightarrow$ $\lim_{x\to x_0}f(x)=\lim_{x\to x_0}f(x_0)+f'(x_0)(x-x_0)+o(x-x_0)= f(x_0)$.
...
>Teorema
> **Sia $f:(a,b)\to \mathbb{R}, x_0 \in (a,b), f \text { invertibile}, g = f^{-1}, f^{-1}(x_0) \mathbb{N}e 0, f \text{ continua in }(a,b)$. Allora $g$ è derivabile in $y_0= f(x_0)$ e $g'(y_0)= \frac 1{f'(x_0)}= \frac 1{f'(f^{-1}(y_0))}$.**
> 
...
$\mathbb{R}ightarrow$  $f(x_0+h)\le f(x_0)$, in quanto $f(x_0)$  è massimo locale.

- $h>0$ $\mathbb{R}ightarrow$ $\frac{f(x_0+h)-f(x_0)}{h}\le 0$, essendo il numeratore negativo, mentre il denominatore positivo.
Essendo $f$ derivabile in $x_0$, per permanenza del segno segue che
$f'(x_0)=f_+'(x_0)=\lim_{h\to 0^+}\frac{f(x_0+h)-f(x_0)}{h}\le 0$
- $h<0$ $\mathbb{R}ightarrow$ $\frac{f(x_0+h)-f(x_0)}{h}\ge 0$, essendo sia numeratore che denominatore negativi.
Dato che $f$ è derivabile in $x_0$, per permanenza del segno segue che
$f'(x_0)=f_-'(x_0)=\lim_{h\to 0^-}\frac{f(x_0+h)-f(x_0)}{h}\ge 0$

$\mathbb{R}ightarrow$ $f'(x_0)\le 0 \wedge f'(x_0)\ge 0 \Leftrightarrow f'(x_0)=0$
...
Quindi $x_0 \max / \min \mathbb{R}ightarrow f'(x_0)=0$
$f'(x_0)=0 \mathbb{N}Rightarrow x_0\max/\min$
...
3. $g(a)= 0$ e $g(b) =0$ $\mathbb{R}ightarrow g(a)=g(b)$
...
$\mathbb{R}ightarrow 0 = g'(x)=f'(x)-\frac{f(b)-f(a)}{b-a}$ $\mathbb{R}ightarrow f'(x) = \frac{f(b)-f(a)}{b-a}, \forall x \in [a,b]$
- Se $M\mathbb{N}e m$, allora almeno uno dei due deve essere diverso da $0$ - che corrisponde alla quota di $a$ e $b$ - e quindi non può essere assunto negli estremi $a$ e $b$, ma in un punto $c\in (a,b)$
$\mathbb{R}ightarrow$  $c$ è punto di estremo $\mathbb{R}ightarrow$  $g'(c) =0$ per il Teorema di Fermat
$\mathbb{R}ightarrow$ $0 = g'(c)=f'(c)-\frac{f(b)-f(a)}{b-a}$ e per algebra dei limiti abbiamo che $f'(c) = \frac{f(b)-f(a)}{b-a}$
...
Assumiamo per semplicità che sia $x_1<x_2$ e consideriamo la funzione $g:[x_1;x_2]\to \mathbb{R}$, $g(x) = f(x)$. Allora $g$ è derivabile e quindi continua in $[x_1;x_2]$ essendolo $f$ per ipotesi.
    ...
    $\mathbb{R}ightarrow$  $f'(c) = \frac{f(x_2)-f(x_1)}{x_2-x_1}=0$
    
    $\mathbb{R}ightarrow$ $f(x_2)-f(x_1)=0$ $\mathbb{R}ightarrow$ $f(x_2)=f(x_1), \forall x_1,x_2 \in I$
    $\mathbb{R}ightarrow f$ è costante.
...
> 3. **$f'(x)>0 , \forall x\in (a,b)\mathbb{R}ightarrow f$ è strettamente crescente**
> 4. **$f'(x)<0 , \forall x\in (a,b)\mathbb{R}ightarrow f$ è strettamente decrescente**
...
- Sia $f:(a,b)\to \mathbb{R}$ derivabile e crescente.
    ...
    - $h>0\mathbb{R}ightarrow x+h>x\mathbb{R}ightarrow f(x+h)>f(x)$
    - $h<0\mathbb{R}ightarrow x+h<x\mathbb{R}ightarrow f(x+h)<f(x)$
    
    Per $h\mathbb{N}e 0$ vale in ambedue i casi che $\frac{f(x+h)-f(x)}{h}\ge 0$
    Poiché $f$ è derivabile, per permanenza del segno vale che
    $f'(x)=\lim_{h\to0}\frac{f(x+h)-f(x)}{h}\ge 0$
    $\mathbb{R}ightarrow f'(x)\ge 0, \forall x\in (a,b)$
...
- Sia $f:(a,b)\to \mathbb{R}$ derivabile e $f'(x)\ge 0, \forall x\in (a,b)$.
    ...
    $\mathbb{R}ightarrow$  $f(x_2)\ge f(x_1)\mathbb{R}ightarrow f$ è crescente.
    

iii**. $f'(x)>0 , \forall x\in (a,b)\mathbb{R}ightarrow f$ è strettamente crescente**
...
$\mathbb{R}ightarrow$  $f(x_2)> f(x_1)\mathbb{R}ightarrow f$ è strettamente crescente.


<img src="https://www.notion.so/icons/circle-alternate_red.svg" alt="https://www.notion.so/icons/circle-alternate_red.svg" width="15px" /> **Osservazione**

Se $f(a,b)\to \mathbb{R}$ è derivabile, allora $f'(x_0)> 0\in (a,b)$ $\mathbb{R}ightarrow f$ è strettamente crescente in $(a,b)$ $\mathbb{R}ightarrow f$ è invertibile in $(a,b)$
...
> **Siano $f,g:(a,b)\to\mathbb{R}$ derivabili, $g,g'\mathbb{N}e0\in (a,b)$. Se accade che**
> 
...
**Se $\mathbb{N}exists \lim _{x\to a^+}\frac{f'(x)}{g'(x)}$, non si può concludere nulla su $\lim _{x\to a^+}\frac{f(x)}{g(x)}$.**
...
- È possibile che $\mathbb{N}exists \lim_{x\to a^+}f'(x)$, ma esista $f_+'(a)$. Un caso può essere la funzione $f(x) = x^2\sin \frac 1x, x\mathbb{N}e 0$, con $f(0) = 0$.
