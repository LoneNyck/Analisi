...
a meno di forme di indeterminazione $\infty - \infty, 0\cdot \infty, {0\over 0}, {\infty \over \infty}, 1^\infty, \infty^0, 0^0$ oppure del caso $c\over 0$, con $c\in \overline \R\setminus\{0\}$ e $0$ né $0^+$ né $0^-$.

# 4. Teorema sull’algebra delle funzioni continue.

Siano $f$ e $g$ sono funzioni continue in $x_0\in\R$, cioè $\lim_{x\to x_0}f(x)=f(x_0)$ e $\lim_{x\to x_0}g(x)=g(x_0)$.
Allora:
...
Se:**
> 
> 1. **$\lim_{x\to x_0}g(x) = t_0\in \overline \R$**
