...
**Siano $f: I \subseteq \mathbb{R} \to \mathbb{R}$, $x_0 \in \mathbb{R}$ punto di accumulazione per $I$. Diremo che una funzione $f$ soddisfa una proprietà $p$ definitivamente per $x\to x_0$se $\exists U(x_0)$ intorno di $x_0$ tale che $p$ sia soddisfatta $\forall x \in U(x_0), x\mathbb{N}e x_0$.** 
...
> 
> 1. $\exists\lim_{x\to x_0}f(x)= +\infty$ $\mathbb{R}ightarrow$ $\exists\lim_{x\to x_0}g(x)= +\infty$
> 2. $\exists\lim_{x\to x_0}g(x)= -\infty$ $\mathbb{R}ightarrow$ $\exists\lim_{x\to x_0}f(x)= -\infty$
...
$\exists\lim_{x\to x_0}g=0$ $\mathbb{R}ightarrow$ $\exists\lim_{x\to x_0}f=0$**
2. **Date due funzioni $f$ e $g$  tali che $f$ sia limitata ed $\exists\lim_{x\to x_0}g=0$ $\mathbb{R}ightarrow$ $\exists\lim_{x \to x_0}f(x)g(x)=0$**
...
$\mathbb{R}ightarrow$  $f(x) > 0$ definitivamente per $x\to x_0$. 
Similmente se $\ell<0$
$\mathbb{R}ightarrow$ $f(x) < 0$ definitivamente per $x\to x_0$.**
> 
...
$\forall \epsilon >0 \exists \delta > 0:0<|x-x_0|<\delta \mathbb{R}ightarrow \ell-\epsilon < f(x)<\ell+\epsilon$.
...
$\mathbb{R}ightarrow$  $\ell \ge 0$ definitivamente per $x\to x_0$. 
Similmente se $f(x) \le 0$
$\mathbb{R}ightarrow$ $\ell \le 0$ definitivamente per $x\to x_0$.**
> 

### 2.2.1 Dimostrazione

Utilizziamo per questa dimostrazione la definizione successionale di limite: sia $x_n$  una successione qualsiasi tale che $x_n \in D_f \ \forall n \in \mathbb{N}$, $x_n \mathbb{N}eq x_0 \ \forall n \in \mathbb{N}$ e $\lim_{n\to\infty}x_n = x_0$; allora $\lim_{n\to\infty}f(x_n) = \ell$.
...
3. $\lim_{x\to x_0}{f(x)\over g(x)}= {\ell_1 \over \ell_2}$, con $g(x) \mathbb{N}e 0$ in un intorno di $x_0$, salvo al più $x_0$
...
3. $\lim_{x\to x_0}{f(x)\over g(x)}= {f(x_0) \over g(x_0)}$, con $g(x) \mathbb{N}e 0$ in un intorno di $x_0$, salvo al più $x_0$
...
> 3. **$g(x) \mathbb{N}e t_0$ definitivamente per $x \to x_0$**
> 
