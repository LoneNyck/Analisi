...
>Definizione: Intorno
>**Dato $x_0\in \R$, chiamiamo intorno di $x_0$ un insieme della forma 
$U(x_0) = (x_0 -\epsilon; x_0 + \epsilon), \forall \epsilon > 0$.**
>
>**Chiamiamo intorno di $+\infty$ un insieme della forma 
$U(+\infty) = (M;  +\infty), \forall M \in \R$.**
>
>**Chiamiamo intorno di $-\infty$ un insieme della forma 
$U(-\infty) = (-\infty; M), \forall M \in \R$.**
...
- $x_0 \in U(x_0), \forall x_0 \in \R, \forall \epsilon > 0$
- $+\infty \notin U(+\infty), \forall M \in \R$
- $-\infty \notin U(-\infty), \forall M \in \R$

## 1.2. Punti di accumulazione

>Definizione: Punto di accumulazione
>**Dati $x_0 \in \overline \R$ e $I \subseteq$ $\R$ insieme, diremo che $x_0$ è punto di accumulazione per $I$ se e solo se ogni intorno di  $x_0$ soddisfa 
...
Specificando nella definizione topologica di limite la forma esplicita degli intorni $U(\ell)$  e $U(x_0)$ nei casi $x_0 \in \R \cup \{+\infty\} \cup \{-\infty\}$ e $\ell \in \R \cup \{+\infty\} \cup \{-\infty\}$ si trovano le 9 definizioni metriche di limite, che non riportiamo.
...
**Diremo che $f$ ha asintoto orizzontale $y = \ell \in \R$ per $x \to \pm\infty$ se $\lim_{x\to\pm\infty}f (x)= \ell$**
...
**Diremo che $f$ ha asintoto obliquo $y = mx +q$, con $m \in \R \setminus\{0\}$ e $q \in \R$,  per $x \to \pm\infty$ se $\lim_{x\to\pm\infty}|f (x)- (mx +q)|= 0$**
...
> Teorema
> **$f$  ha asintoto obliquo a $\pm \infty$ se $\lim_{x-\to\pm\infty} {f(x) \over x} = m \in \R \setminus\{0\}$ e $\lim_{x\to\pm\infty}f (x)- mx= q \in \R$. L’asintoto sarà quindi $y = mx +q$.**
> 
...
Domandarsi se $f: (-\infty; 0)\cup(0; +\infty)\to \R$ definita da $f(x) = \frac{1}{x}$ sia continua o meno non ha senso secondo la definizione di continuità appena data, non essendo $f$ definita in $0$.

---

Siano d’ora in avanti **$f: I \subseteq \R \to \R$, $x_0 \in \R$ punto di accumulazione per $I$, $x_0 \in I$.**
