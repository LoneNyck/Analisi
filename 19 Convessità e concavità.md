...
>**Una funzione $f:I \subseteq \R\to \R$, con $I$  intervallo, si dice convessa in $I$ se 
...
>**Una funzione $f:I \subseteq \R\to \R$, con $I$  intervallo, si dice concava se $-f$ è convessa.**
...
Dati due punti in $\R^2$ $\underline P_0(x_0,y_0), \underline P_1(x_1,y_1)$ , l’insieme dei punti 
$\underline P_t=(1-t)\underline P_0 + t\underline P_1 = \underline P_0 + t(\underline P_1- \underline P_0)= \\\big((1-t) x_0 + t x_1, (1-t )y_0 + t y_1\big)$ è la retta in $\R^2$ passante per i punti $\underline P_0,\underline P_1$.
...
In generale, se $\underline P_0,\underline P_1 \in \R^n$, con $n\ge2$, l’espressione descriverebbe per $t\in \R$ la retta passante per i due punti.


<img src="https://www.notion.so/icons/circle-alternate_red.svg" alt="https://www.notion.so/icons/circle-alternate_red.svg" width="15px" /> **Osservazione**

Se $f:I \subseteq \R\to \R$, con $I$  intervallo, $f$ è convessa in $I$  se e solo se $\forall x_0,x_1\in I$  e $\forall t\in [0,1]$ vale che $f(tx_1+(1-t)x_0)\le tf(x_1)+(1-t)f(x_0)$, da definizione.
...
Possiamo anche scrivere - per quanto riguarda $\R^2$ - che
...
>Teorema
> **Sia $f:I \subseteq \R\to \R$, con $I$  intervallo, tale che $f$ sia convessa in $I$. Allora $f$ è continua in $I$, salvo al più gli estremi di $I$. Inoltre essa possiede derivata destra e sinistra in ogni punto dell’intervallo, salvo al più gli estremi di $I$.**
> 

>Teorema
> **Sia $f:I \subseteq \R\to \R$, con $I$  intervallo, derivabile in $I$. Allora $f$ è convessa in $I$ se e solo se $f(x) > f(x_0)+f'(x_0)(x-x_0), \forall x\in I, \forall x_0 \in I$, cioè $f$ giace interamente sopra la tangente al suo grafico in $P_o(x_0, f(x_0)), \forall x_0\in I$.**
> 

<img src="https://www.notion.so/icons/circle-alternate_red.svg" alt="https://www.notion.so/icons/circle-alternate_red.svg" width="15px" /> **Osservazione**
$f= |x|$ è convessa anche se non è derivabile in tutto $\R$


![image.png](19%20Convessit%C3%A0%20e%20concavit%C3%A0/image.png)

>Teorema
> **Sia $f:I \subseteq \R\to \R$, con $I$  intervallo.**
> 
...
<img src="https://www.notion.so/icons/circle-alternate_red.svg" alt="https://www.notion.so/icons/circle-alternate_red.svg" width="15px" /> **Osservazione**
Se $f:(a,b) \to \R$ è derivabile almeno una volta in $x_0$ e $x_0$ è punto di cambio di concavità, allora $x_0$   è punto di flesso.



>Teorema
> **Siano $f:(a,b) \to \R$ e $x_0\in(a,b)$. Se $f$ è derivabile due volte in $x_0$ e $x_0$ è punto di flesso per $f$, allora $f''(x_0)=0$.**
> 

<img src="https://www.notion.so/icons/circle-alternate_red.svg" alt="https://www.notion.so/icons/circle-alternate_red.svg" width="15px" /> **Osservazione** $x_0$  punto di flesso $\Rightarrow$  $f''(x_0) = 0$
$f''(x_0) = 0\nRightarrow$ $x_0$  punto di flesso

Un esempio può essere la funzione $f(x) = x^4$, convessa in tutto $\R$, con derivata seconda che si annulla in $x=0$, ma che non può essere punto di flesso essendo minimo assoluto della funzione.
