...
- $\lim_{x\to x_0}{f(x)\over g(x)} = \lambda \in \mathbb{R} \setminus \{0\}$ $\mathbb{R}ightarrow$ $f(x) \sim \lambda g(x)$ , $x\to x_0$.
- $\lim_{x\to x_0}{f(x)\over g(x)} = \pm \infty$ $\mathbb{R}ightarrow$ $g(x) = o(f(x))$ , $x\to x_0$.
...
1. $f_1 \pm g_1 \mathbb{N}sim  f_2 \pm g_2$
2. $\log(f_1)  \mathbb{N}sim  \log(f_2)$
3. $e^{f_1} \mathbb{N}sim  e^{f_2}$
